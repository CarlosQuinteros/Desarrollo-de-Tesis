...
public class ProvinciaController {
    ...
    /*
        Metodo para crear una nueva Provincia*
     */
    ...
    public ResponseEntity<?> crearProvincia(@Valid @RequestBody ProvinciaDto provinciaDto, BindingResult bindingResult){
        ...
        try{
            ...
            return new ResponseEntity<>(new Mensaje("Provincia guardada correctamente"), HttpStatus.CREATED);
        }catch (Exception e){
    ...
    /*
        Metodo que devuelve el listado de provincias
     */
    @PreAuthorize("hasRole('ADMIN')")
    @GetMapping("/listado")
    ...
    /*
        Metodo que permite eliminar una provincia si no tiene localidades asociadas
     */
    @PreAuthorize("hasRole('ADMIN')")
    ...
    /*
        Metodo que retorna una provincia y sus localidades
     */
    @PreAuthorize("hasRole('ADMIN')")
    ...
    /*
        Metodo que permite editar una provincia
     */
    @PreAuthorize("hasRole('ADMIN')")
